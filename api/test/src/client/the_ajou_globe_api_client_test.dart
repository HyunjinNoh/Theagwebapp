...
void main() {
  ...
  group('TheAjouGlobeApiClient', () {
    late http.Client httpClient;
    late TheAjouGlobeApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = TheAjouGlobeApiClient(
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = TheAjouGlobeApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => TheAjouGlobeApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = TheAjouGlobeApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws TheAjouGlobeApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<TheAjouGlobeApiMalformedResponse>()),
        );
      });

      test(
          'throws TheAjouGlobeApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<TheAjouGlobeApiRequestFailure>()
