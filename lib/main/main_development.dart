...
import 'package:the_ajou_globe/main/bootstrap/bootstrap.dart';
import 'package:the_ajou_globe/src/version.dart';
  ...
  bootstrap(
    (
      ...
      final packageInfoClient = PackageInfoClient(
        appName: 'The Ajou Globe [DEV]',
        packageName: 'kr.ac.ajou.engpress.news.template.dev',
